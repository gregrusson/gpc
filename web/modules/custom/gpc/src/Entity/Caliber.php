...
#[ContentEntityType(
  ...
  links: [
    'canonical' => '/calibers/{gpc_caliber}',
    'collection' => '/admin/gpc/calibers',
    'add-form' => '/admin/gpc/calibers/add',
    'edit-form' => '/admin/gpc/calibers/{gpc_caliber}/edit',
    'delete-form' => '/admin/gpc/calibers/{gpc_caliber}/delete',
  ],
