...
- The app shell keeps the browser window fixed and uses `#main-content.gpc-main` as the primary vertical scroll container, so long forms scroll in the content area while the sidebar stays full height.
